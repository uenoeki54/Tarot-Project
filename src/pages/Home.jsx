...
function Home() {
  const [theme, setTheme] = useState('cunt');
        ...
        <div className="text">
          ...
          <p>
            <i>
              ...
              condi tions. You see, man always felt the need of finding an
              access through the unconscious to the meaning of an actual
              condition, because there is a sort of correspondence or a likeness
              between the prevailing condition and the condition of the
          ...
          <br />
          <p>
            The purpose of this online tool is to provide as diverse as possible
            a support for intepretation of and meditation upon Tarot cards.
            <br />
            <br />
